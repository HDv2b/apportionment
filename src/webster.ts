 ...
 * Webster — divisor method; rounds quotas to nearest integer and adjusts divisor.
 *
 * Method:
 ...
 * - Initial (round) = [5, 3, 2, 1, 0] -> Final allocation: [5, 3, 2, 1, 0]
 *
 * Favours: mildly larger states.
 *
 * Pros:
 * - Generally fairer near-proportional results compared to Jefferson.
 *
 * Cons:
 * - Can still violate the quota rule occasionally.
 *
...
export function webster(
	...
	return adjustDivisor(populations, seats, Math.round, logFn);
}
